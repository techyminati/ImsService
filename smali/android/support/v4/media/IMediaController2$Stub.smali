...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :goto_1
    invoke-virtual {v15, v0, v1, v2}, Landroid/support/v4/media/IMediaController2$Stub;->onSearchResultChanged(Ljava/lang/String;ILandroid/os/Bundle;)V
    ...
    .restart local v2    # "_arg2":Landroid/os/Bundle;
    :goto_3
    invoke-virtual {v15, v0, v1, v2}, Landroid/support/v4/media/IMediaController2$Stub;->onChildrenChanged(Ljava/lang/String;ILandroid/os/Bundle;)V
    ...
    :goto_4
    invoke-virtual {v15, v0, v1}, Landroid/support/v4/media/IMediaController2$Stub;->onGetItemDone(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    .restart local v2    # "_arg2":Landroid/os/Bundle;
    :goto_6
    invoke-virtual {v15, v0, v1, v2}, Landroid/support/v4/media/IMediaController2$Stub;->onGetLibraryRootDone(Landroid/os/Bundle;Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    :goto_9
    invoke-virtual {v15, v0, v1, v2}, Landroid/support/v4/media/IMediaController2$Stub;->onCustomCommand(Landroid/os/Bundle;Landroid/os/Bundle;Landroid/os/ResultReceiver;)V
    ...
    .line 220
    .local v21, "_arg3":Landroid/os/Bundle;
    :goto_c
    ...
    .line 235
    .local v29, "_arg8":Landroid/os/Bundle;
    :goto_d
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    .line 241
    .local v32, "_arg11":Ljava/util/List;, "Ljava/util/List<Landroid/os/Bundle;>;"
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    .local v0, "_arg12":Landroid/app/PendingIntent;
    goto :goto_e

    .line 245
    .end local v0    # "_arg12":Landroid/app/PendingIntent;
    :cond_e
    const/4 v0, 0x0
    ...
    .line 247
    .local v33, "_arg12":Landroid/app/PendingIntent;
    :goto_e
    move-object/from16 v0, p0
    ...
    .end local v21    # "_arg3":Landroid/os/Bundle;
    .end local v22    # "_arg4":J
    .end local v24    # "_arg5":J
    .end local v26    # "_arg6":F
    .end local v27    # "_arg7":J
    .end local v29    # "_arg8":Landroid/os/Bundle;
    .end local v30    # "_arg9":I
    .end local v31    # "_arg10":I
    .end local v32    # "_arg11":Ljava/util/List;, "Ljava/util/List<Landroid/os/Bundle;>;"
    .end local v33    # "_arg12":Landroid/app/PendingIntent;
    :pswitch_b
    ...
    .restart local v1    # "_arg1":Landroid/os/Bundle;
    :goto_f
    invoke-virtual {v8, v0, v1}, Landroid/support/v4/media/IMediaController2$Stub;->onError(ILandroid/os/Bundle;)V
    ...
    .restart local v1    # "_arg1":Landroid/os/Bundle;
    :goto_12
    invoke-virtual {v8, v0, v1}, Landroid/support/v4/media/IMediaController2$Stub;->onPlaylistChanged(Ljava/util/List;Landroid/os/Bundle;)V
