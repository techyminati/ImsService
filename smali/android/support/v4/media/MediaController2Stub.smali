...
.method public onAllowedCommandsChanged(Landroid/os/Bundle;)V
    ...
    .line 288
    .local v1, "controller":Landroid/support/v4/media/MediaController2ImplBase;
    nop
    ...
    .line 294
    .local v2, "commands":Landroid/support/v4/media/SessionCommandGroup2;
    if-nez v2, :cond_1
    ...
    .line 298
    :cond_1
    invoke-virtual {v1, v2}, Landroid/support/v4/media/MediaController2ImplBase;->onAllowedCommandsChanged(Landroid/support/v4/media/SessionCommandGroup2;)V

    .line 299
    return-void

    .line 285
    .end local v1    # "controller":Landroid/support/v4/media/MediaController2ImplBase;
    .end local v2    # "commands":Landroid/support/v4/media/SessionCommandGroup2;
    :catch_0
    move-exception v1
...
.method public onCustomCommand(Landroid/os/Bundle;Landroid/os/Bundle;Landroid/os/ResultReceiver;)V
    ...
    .line 315
    :cond_0
    invoke-virtual {v1, v2, p2, p3}, Landroid/support/v4/media/MediaController2ImplBase;->onCustomCommand(Landroid/support/v4/media/SessionCommand2;Landroid/os/Bundle;Landroid/os/ResultReceiver;)V
...
.method public onGetChildrenDone(Ljava/lang/String;IILjava/util/List;Landroid/os/Bundle;)V
    ...
    .line 373
    const-string v0, "onGetChildrenDone(): Ignoring null parentId"
    ...
    invoke-direct/range {v2 .. v9}, Landroid/support/v4/media/MediaController2Stub$3;-><init>(Landroid/support/v4/media/MediaController2Stub;Landroid/support/v4/media/MediaBrowser2;Ljava/lang/String;IILjava/util/List;Landroid/os/Bundle;)V
...
.method public onGetSearchResultDone(Ljava/lang/String;IILjava/util/List;Landroid/os/Bundle;)V
    ...
    .line 425
    const-string v0, "onGetSearchResultDone(): Ignoring empty query"
...
.method public onPlaybackInfoChanged(Landroid/os/Bundle;)V
    ...
    .line 169
    .local v2, "info":Landroid/support/v4/media/MediaController2$PlaybackInfo;
    if-nez v2, :cond_0
    ...
    .line 173
    :cond_0
    invoke-virtual {v1, v2}, Landroid/support/v4/media/MediaController2ImplBase;->notifyPlaybackInfoChanges(Landroid/support/v4/media/MediaController2$PlaybackInfo;)V
    ...
    .line 164
    .end local v1    # "controller":Landroid/support/v4/media/MediaController2ImplBase;
    .end local v2    # "info":Landroid/support/v4/media/MediaController2$PlaybackInfo;
    :catch_0
    move-exception v1
...
.method public onPlaylistChanged(Ljava/util/List;Landroid/os/Bundle;)V
    ...
    .line 107
    .local v2, "playlist":Ljava/util/List;, "Ljava/util/List<Landroid/support/v4/media/MediaItem2;>;"
    ...
    invoke-virtual {v1, v2, v0}, Landroid/support/v4/media/MediaController2ImplBase;->notifyPlaylistChanges(Ljava/util/List;Landroid/support/v4/media/MediaMetadata2;)V

    .line 117
    return-void

    .line 98
    .end local v0    # "metadata":Landroid/support/v4/media/MediaMetadata2;
    .end local v1    # "controller":Landroid/support/v4/media/MediaController2ImplBase;
    .end local v2    # "playlist":Ljava/util/List;, "Ljava/util/List<Landroid/support/v4/media/MediaItem2;>;"
    :catch_0
    move-exception v1
