...
.method public run()V
    ...
    .line 347
    const-string v6, "android.support.v4.media.argument.ALLOWED_COMMANDS"
    ...
    const-string v6, "android.support.v4.media.argument.PLAYER_STATE"
    ...
    const-string v6, "android.support.v4.media.argument.BUFFERING_STATE"
    ...
    .line 351
    const-string v6, "android.support.v4.media.argument.PLAYBACK_STATE_COMPAT"
    ...
    const-string v6, "android.support.v4.media.argument.REPEAT_MODE"
    ...
    const-string v7, "android.support.v4.media.argument.MEDIA_ITEM"
    ...
    .line 368
    invoke-interface {v6}, Landroid/support/v4/media/MediaSession2$SupportLibraryImpl;->getPlaybackInfo()Landroid/support/v4/media/MediaController2$PlaybackInfo;

    move-result-object v6

    invoke-virtual {v6}, Landroid/support/v4/media/MediaController2$PlaybackInfo;->toBundle()Landroid/os/Bundle;

    move-result-object v6

    .line 367
    const-string v7, "android.support.v4.media.argument.PLAYBACK_INFO"
    ...
    .line 371
    const-string v8, "android.support.v4.media.argument.PLAYLIST_METADATA"

    invoke-virtual {v1, v8, v7}, Landroid/os/Bundle;->putBundle(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    const-string v4, "Rejecting connection, controllerInfo="
