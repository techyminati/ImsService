...
.method public maybeFilterPauseResume(Landroid/telecom/VideoProfile;Landroid/telecom/VideoProfile;I)Landroid/telecom/VideoProfile;
    ...
    .line 451
    const-string v2, "maybeFilterPauseResume: isPauseRequest (from=%s, to=%s)"

    invoke-static {p0, v2, v7}, Landroid/telecom/Log;->i(Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 479
    const-string v2, "maybeFilterPauseResume: isResumeRequest, but camera turning on/off so skipping (from=%s, to=%s)"
    ...
    .line 485
    const-string v2, "maybeFilterPauseResume: isResumeRequest (from=%s, to=%s)"
...
.method public onVideoStateChanged(I)V
    ...
    iget v3, p0, Lcom/android/ims/internal/ImsVideoCallProviderWrapper;->mCurrentVideoState:I
    ...
    .line 574
    const-string v1, "onVideoStateChanged: currentVideoState=%s, newVideoState=%s, clearing pending pause requests."
    ...
    .line 580
    const-string v1, "onVideoStateChanged: currentVideoState=%s, newVideoState=%s"
