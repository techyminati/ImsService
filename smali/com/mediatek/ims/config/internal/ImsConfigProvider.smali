...
.method private notifyChange(Landroid/net/Uri;Lcom/mediatek/ims/config/internal/ImsConfigProvider$Arguments;Landroid/content/ContentValues;)V
    ...
    .local v2, "isSimStateAllow":Z
    goto :goto_7

    .line 314
    .end local v2    # "isSimStateAllow":Z
    ...
    .line 319
    .end local v18    # "isSimStateAllow":Z
    .restart local v2    # "isSimStateAllow":Z
    :goto_7
    if-nez v2, :cond_e
    ...
    invoke-virtual {v7, v0, v9}, Landroid/content/ContentResolver;->notifyChange(Landroid/net/Uri;Landroid/database/ContentObserver;)V

    .line 331
    sget-object v7, Lcom/mediatek/ims/config/internal/ImsConfigProvider;->ECCAllowBroadcast:Ljava/util/HashMap;
    ...
    .end local v16    # "isSimStateAllow":Z
    .end local v17    # "isFeatureEnabled":Z
