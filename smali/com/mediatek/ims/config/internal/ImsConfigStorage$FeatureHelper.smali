...
.method private initFeatureStorage()V
    ...
    invoke-direct {p0, v5, v1, v2}, Lcom/mediatek/ims/config/internal/ImsConfigStorage$FeatureHelper;->updateFeature(III)V
    ...
    invoke-direct {p0, v5, v6, v1}, Lcom/mediatek/ims/config/internal/ImsConfigStorage$FeatureHelper;->updateFeature(III)V
...
.method getFeatureValue(II)I
    ...
    .line 863
    invoke-static {v5, p1, p2}, Lcom/mediatek/ims/config/ImsConfigContract$Feature;->getUriWithFeatureId(III)Landroid/net/Uri;
    ...
    invoke-direct {v3, v5, v4}, Lcom/android/ims/ImsException;-><init>(Ljava/lang/String;I)V
